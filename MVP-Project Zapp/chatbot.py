...
customer_data_path = 'MVP/customer_data.json'
customer_chat = 'MVP/customer_chat.json'
...
def train_chatbot(customer_chatbot):
    try:
...
def create_chatbot():
    customer_chatbot = ChatBot('CustomerZapp')
...
def init():
    ...
    customer_chatbot = create_chatbot()
    #Training the chatbots
    train_chatbot(customer_chatbot)
...
@app.route("/")
def home():
    return render_template("zapp_home.html")
